...
```{r,echo=FALSE}
knitr::include_graphics("https://raw.githubusercontent.com/cardiomoon/ggplotAssist/master/man/figures/1.jpg")
```
...
```{r,echo=FALSE}
knitr::include_graphics("https://raw.githubusercontent.com/cardiomoon/ggplotAssist/master/man/figures/2.jpg")
```

3. You can see the R code for ggplot(1). Select `y` and `brainwt` to map the y-axis variable. 

```{r,echo=FALSE}
knitr::include_graphics("https://raw.githubusercontent.com/cardiomoon/ggplotAssist/master/man/figures/3.jpg")
```
...
```{r,echo=FALSE}
knitr::include_graphics("https://raw.githubusercontent.com/cardiomoon/ggplotAssist/master/man/figures/5.jpg")
```
...
```{r,echo=FALSE}
knitr::include_graphics("https://raw.githubusercontent.com/cardiomoon/ggplotAssist/master/man/figures/6.jpg")
```
...
```{r,echo=FALSE}
knitr::include_graphics("https://raw.githubusercontent.com/cardiomoon/ggplotAssist/master/man/figures/7.jpg")
```
...
```{r,echo=FALSE}
knitr::include_graphics("https://raw.githubusercontent.com/cardiomoon/ggplotAssist/master/man/figures/8.jpg")
```
...
```{r,echo=FALSE}
knitr::include_graphics("https://raw.githubusercontent.com/cardiomoon/ggplotAssist/master/man/figures/9.jpg")
```
...
```{r,echo=FALSE}
knitr::include_graphics("https://raw.githubusercontent.com/cardiomoon/ggplotAssist/master/man/figures/10.jpg")
```
...
```{r,echo=FALSE}
knitr::include_graphics("https://raw.githubusercontent.com/cardiomoon/ggplotAssist/master/man/figures/11.jpg")
```

11. When you're done, the code for the ggplot will be emitted at the cursor position(scarlet rectangle).

```{r,echo=FALSE}
knitr::include_graphics("https://raw.githubusercontent.com/cardiomoon/ggplotAssist/master/man/figures/12.jpg")
```
